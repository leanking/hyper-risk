...
echo -e "${GREEN}=== HyperLiquid Risk Dashboard Blueprint Deployment ===${NC}"
echo -e "${YELLOW}This script will help you deploy your application to Render using Blueprints.${NC}"
echo
...
echo
echo -e "${YELLOW}Next steps for Blueprint deployment on Render:${NC}"
echo
...
echo -e "5. Render will detect your render.docker.yaml file"
